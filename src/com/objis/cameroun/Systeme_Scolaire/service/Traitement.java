...
public class Traitement implements ITraitements {
	...
	public void enregistrerEleve(Eleve eleve) {
		...
		//instructions permettant de recuperer les informations d'un enseignant entrées au clavier par l'utilisateur
				...
				dao.enregistrerEleveDao(eleve); // instruction qui enregistre l'eleve dans la BD
	...
	public void listerElevesService() {
		...
		maListe=dao.listerElevesDao();
		
		if(maListe.isEmpty()==true) {
			System.out.println("Aucun eleve n'a ete trouve dans le base de données");
		}else {
			System.out.println("Nous avons "+maListe.size()+" eleves enregistres : \n");
			System.out.println("Voici la liste des eleves enregistres: \n");
